  ...
  return (
    <motion.div variants={variants} initial="hidden" animate="visible">
      <motion.div variants={itemVariants}>
        <PageHeader eyebrow={<span>Dashboard / <b>Câu luyện tập</b></span>} title="Câu luyện tập" />
      </motion.div>
      <motion.div variants={itemVariants} style={{ display: "grid", placeItems: "center", minHeight: "50vh", textAlign: "center", padding: "40px 20px" }}>
        ...
        <p style={{ fontSize: 14, color: "#64748b", maxWidth: 400, lineHeight: 1.6, margin: 0 }}>
          Trang quản lý câu luyện tập đang được xây dựng. Tính năng này sẽ sớm được hoàn thiện.
        </p>
      </motion.div>
    </motion.div>
  )
